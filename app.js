...
const UF={
 entrada:{label:"Entrada",svg:'<path d="M30 4V44M20 14l10-10 10 10"/>'},medidor:{label:"Medidor",svg:'<rect x="12" y="10" width="36" height="32"/><circle cx="30" cy="26" r="9"/><text x="30" y="30">M</text>'},
 ...
 disjuntor:{label:"Disjuntor",svg:'<path d="M30 4V16M30 36V48M30 16L43 28M30 36L43 28"/><circle cx="30" cy="16" r="2"/><circle cx="30" cy="36" r="2"/>'},
 idr:{label:"IDR",svg:'<rect x="13" y="7" width="34" height="38"/><path d="M23 12V20L36 31M23 39V32L36 31"/><text x="39" y="18">Δ</text>'},dps:{label:"DPS",svg:'<rect x="15" y="7" width="30" height="38"/><path d="M30 11L23 27H31L25 41L39 22H31Z"/>'},
